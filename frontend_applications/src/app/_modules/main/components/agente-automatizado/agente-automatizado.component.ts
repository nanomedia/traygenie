...
@Component({
  selector: 'app-agente-automatizado',
  templateUrl: './agente-automatizado.component.html',
  styleUrls: ['./agente-automatizado.component.scss']
})
export class AgenteAutomatizadoComponent extends BaseComponent implements OnInit {
  ...
  private serviceName = 'sign_agent';
